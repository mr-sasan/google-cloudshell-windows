...
#unzipping ngrok-v3-stable-windows-amd64.zip in selected folder
...
screen -d -m docker run -p 8080:80 -e RESOLUTION=1366x768 -v /dev/shm:/dev/shm dorowu/ubuntu-desktop-lxde-vnc
